    ...
    >
      ...
      <div class="absolute inset-0 w-full h-full overflow-y-auto overflow-x-hidden flex flex-col px-6 md:px-24 pt-32 pb-24">
        ...
        <div class="max-w-5xl relative w-full m-auto transition-opacity duration-1000 ease-out z-10" :class="isOpen ? 'opacity-100 delay-300' : 'opacity-0'">
          ...
          <h1 id="about-title" class="text-5xl md:text-7xl font-handwriting tracking-tighter mb-12 relative z-10 text-moss-dark mix-blend-multiply">
            Nice to meet you.
          </h1>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 relative z-10">
            ...
            <div class="relative">
              ...
              <h2 class="text-[10px] font-black uppercase tracking-[0.3em] text-ink/70 mb-6">The Journey</h2>
              ...
              <h2 class="text-[10px] font-black uppercase tracking-[0.3em] text-ink/70 mb-6">The Core</h2>
            ...
            <div class="relative flex flex-col justify-between">
              <div>
                ...
                <h2 class="text-[10px] font-black uppercase tracking-[0.3em] text-ink/70 mb-6">The Stack</h2>
              ...
              <div class="mt-12 md:mt-0">
                <h2 class="text-[10px] font-black uppercase tracking-[0.3em] text-ink/70 mb-6">Beyond the Screen</h2>
                <p class="font-serif text-lg leading-relaxed text-ink/90 mix-blend-multiply">
